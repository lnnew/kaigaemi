    ...
    <html>
      ...
      var quantities=[{
                    ...
                    function refresh() {
                      ...
                      $("#budget_jango").attr('data-count',10000*budget);
                      $("#budget_jango").text(10000*budget);
                      $("#budget_cash").attr('data-count',10000*cash);
                      $("#budget_cash").text(10000*cash);
                      if (leverage[0]){
    ...
    <p id ="gyul" style="margin-left:30px">${year}년 결과</p>
      ...
      <tr>
        ...
        <div class = "w3-col s2 w3-card header_card">
          ...
          <hr/>
          <p id ="budget_jango" data-count ="1" class="nums_ani" style="text-align:center;margin-bottom:10px"> 0</p>
        ...
        <div class = "w3-col s2 w3-card header_card">
          ...
          <hr/>
          <p id ="budget_cash" data-count ="1" class="nums_ani" style="text-align:center; margin-bottom:10px"> 0</p>
           <p style="text-align:right; margin:0px; padding-bottom:10px;margin-bottom:0px;">원&emsp;</p>
        </div>
        <div class = "w3-col s2 w3-card header_card">
