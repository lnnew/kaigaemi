    ...
    <p id ="gyul" style="margin-left:30px">${year}년 결과</p>
      ...
      <tr>
        ...
        <div class = "w3-col s2 w3-card header_card">
          ...
          <hr/>
          <p id ="budget_jango" data-count ="${10000* jo_info["budget"]}" class="nums_ani" style="text-align:center;margin-bottom:10px"> 0</p>
        ...
        <div class = "w3-col s2 w3-card header_card">
          ...
          <hr/>
          <p id ="budget_cash" data-count ="${10000* jo_info["cash"]}" class="nums_ani" style="text-align:center; margin-bottom:10px"> 0</p>
           <p style="text-align:right; margin:0px; padding-bottom:10px;margin-bottom:0px;">원&emsp;</p>
        </div>
        <div class = "w3-col s2 w3-card header_card">
        ...
        $('.nums_ani').each(function () {
             ...
             $({
                 ...
                 easing: 'linear',
                 step: function () {
                    raw = Math.floor($this.countNum).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')
                     $this.text(raw);
                 },
                 complete: function () {
                    raw = $this.countNum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')
                    console.log(raw);
                     $this.text(raw);
                     //3자리 마다 콤마 표시 적용
                 }
