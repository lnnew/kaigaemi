module.exports = {
  HTML:function(user, year,jo_info){
    ...
    <div class="ex1">
      <div class ="w3-row" style="padding-bottom:10px;"><div class ="w3-col s3"><h4><b><img src="https://scontent.ficn2-2.fna.fbcdn.net/v/t1.6435-9/171254098_736058853748259_7868857286441811331_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=973b4a&_nc_ohc=LaSUR44QT88AX-YxIs9&_nc_ht=scontent.ficn2-2.fna&oh=00_AfB3Mb4kFcw9vslMVw8PR2ha2N8jkhsMzuSWaSQxn0X-0g&oe=64DD812B"
      ...
      <div class = "w3-col s2 w3-card header_card">
        <p> &emsp;<i class="fa-sharp fa-solid fa-money-bill-transfer" style="color:#01438f"></i>&nbsp;&nbsp;현금</p>
        <hr/>
        <p id ="budget" style="text-align:center; margin-bottom:10px"> 2,000,000</p>
         <p style="text-align:right; margin:0px; padding-bottom:10px;margin-bottom:0px;">원&emsp;</p>
      </div>
      ...
      <div class = "w3-col s2 w3-card header_card">
        ...
        <hr/>
        <p id ="budget" style="text-align:center; font-size:30px"> ${year}</p>
      ...
      <div class="w3-col s2 w3-white stock-card w3-center">
              ...
              <script>
              var year = ${year};
              let budget = ${jo_info["budget"]};
              let cash = ${jo_info["cash"]};
              var prices =[
                        {
                          '2016': 12,
                          '2017': 14,
    ...
    <div class = "w3-col s3">
          ...
          <div class="container">
            ...
            <form  method="post" onsubmit="a_ipchal(this);return false">
              ...
              <input type="checkbox" name="leverage" value="st1_5" >
              <label for="lname">&emsp;x2.0</label>
              <input type="checkbox" name="leverage" value="st2" >
              <script>
    ...
    <div class="w3-col s2" style="font-size:15px;">
